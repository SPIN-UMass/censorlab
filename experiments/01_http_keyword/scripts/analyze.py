#!/usr/bin/env python3
"""Analyze experiment results and output structured data for TeX import.
...
def analyze_showcase():
    ...
    with open(table4_json, "w") as f:
        json.dump({"table": "table4", "experiment": "01_http_keyword", "rows": rows}, f, indent=2)
...
def analyze_live_eval(results_csv):
    ...
    rows = [
        ...
        },
        {
            ...
            "errors": errors,
            "total": len(results),
            "note": "HTTP keyword matching (regex)",
        },
    ]
    ...
    with open(table3_json, "w") as f:
        json.dump({"table": "table3", "experiment": "01_http_keyword", "rows": rows}, f, indent=2)
...
def main():
    ...
    if not has_showcase and not args.live_eval:
        ...
        print("  bash experiments/01_http_keyword/scripts/run_showcase.sh")
        print("  bash experiments/01_http_keyword/scripts/run_evaluation.sh")
