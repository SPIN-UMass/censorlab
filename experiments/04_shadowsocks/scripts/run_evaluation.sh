...
# Shadowsocks-like and normal TLS connections through the censor,
# and computes TPR/TNR.
#
# Prerequisites:
...
#   - A TCP listener on the target port (e.g., ncat -lk 443)
#
# Usage:
#   sudo bash experiments/04_shadowsocks/scripts/run_evaluation.sh
#
...
echo "=== Experiment 4: Shadowsocks Detection — Evaluation (Table 3) ==="
...
# Queue outbound HTTPS traffic to NFQUEUE 0
