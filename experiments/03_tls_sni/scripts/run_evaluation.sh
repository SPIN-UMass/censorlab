...
# TLS ClientHello packets through the censor, and computes TPR/TNR.
#
# Prerequisites:
...
#   - A TLS-capable server running on the target (or just port 443 open)
#
# Usage:
#   sudo bash experiments/03_tls_sni/scripts/run_evaluation.sh
#
...
echo "=== Experiment 3: TLS SNI Filtering — Evaluation (Table 3) ==="
